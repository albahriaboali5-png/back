...
from .views import (
    ...
    NotificationViewSet, FCMTokenViewSet, AIChatViewSet, AdBannerViewSet,
    UserDeviceViewSet, SystemSettingViewSet, SystemStatusView, VerifyDeviceView
)
...
router.register(r'ad-banners', AdBannerViewSet, basename='adbanner')
