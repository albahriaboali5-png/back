...
class UserDevice(models.Model):
    ...
    device_id = models.CharField(max_length=255, help_text="Unique device identifier (MAC or Unique ID)")
    ...
    verification_code = models.CharField(max_length=6, blank=True, null=True, help_text="Verification code sent to primary device")
    ...
    def __str__(self):
        return f"{self.user.username} - {self.device_name} ({'Primary' if self.is_primary else 'Secondary'})"

class SystemSetting(models.Model):
    MAINTENANCE_MODE = 'MAINTENANCE_MODE'
    REGISTRATION_ENABLED = 'REGISTRATION_ENABLED'
    
    key = models.CharField(max_length=50, unique=True, help_text="اسم الإعداد (مثال: MAINTENANCE_MODE)")
    value = models.TextField(help_text="قيمة الإعداد")
